...
public class DemoResource {
	...
	public String usefulAnnotations(@HeaderParam("HeaderValue") String headerAttrib,
			@CookieParam("Idea-e6115726") String idea) {
				
//		return "Header value: "+ headerAttrib +" Cookie idea value: "+idea;
		return "Hello Jax-rs";
	...
	public String contextDemo(@HeaderParam("header") String header) throws Exception {
		...
		if(header==null) {
//			throw new Exception();  goes to GenericExceptionMapper
			throw new NotFoundException();
		}
		return "The value of the header is:" +header;
